...
namespace OnionTopologySuite
{
    ...
    public static class AngleFun
    {
        ...
        public static double Angle(Coord p0, Coord p1)
        {
            double dx = p1.X - p0.X;
            double dy = p1.Y - p0.Y;
        ...
        public static double Angle(Coord p)
        {
        ...
        public static bool IsAcute(Coord p0, Coord p1, Coord p2)
        {
        ...
        public static bool IsObtuse(Coord p0, Coord p1, Coord p2)
        {
        ...
        public static double AngleBetween(Coord tip1, Coord tail, Coord tip2)
        {
        ...
        public static double AngleBetweenOriented(Coord tip1, Coord tail, Coord tip2)
        {
            double a1 = Angle(tail, tip1);
            double a2 = Angle(tail, tip2);
            double angDel = a2 - a1;
        ...
        public static double Bisector(Coord tip1, Coord tail,
            Coord tip2)
        {
        ...
        public static double InteriorAngle(Coord p0, Coord p1, Coord p2)
        {
        ...
        public static Coord Project(Coord p, double angle, double dist)
        {
